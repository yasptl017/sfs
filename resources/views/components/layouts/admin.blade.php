            ...
            <nav class="sidebar-nav space-y-1 px-3 py-4">
                ...
                @if(auth()->user()->isDivision())
                    ...
                    <details class="nav-group" open>
                        ...
                        <div class="nav-submenu"><a href="#">Party Registration</a><a href="#">Allotment from Circle</a><a href="#">Allotment to Range</a><a href="#">Allotment Adjustment</a><a href="#">LC Entry</a><a href="#">Edit LC Entry</a></div>
                    </details>
                @endif
