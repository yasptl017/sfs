        ...
        <aside id="sidebar" class="sidebar border-r border-emerald-100 bg-white/95 shadow-sm">
            ...
            <nav class="sidebar-nav space-y-1 px-3 py-4">
                ...
                @if(auth()->user()->isDivision())
                    ...
                    <details class="nav-group" {{ request()->routeIs('division.process-bill.*') || request()->routeIs('division.gst-challan.*') || request()->routeIs('division.bill-advice-reports.*') || request()->routeIs('division.treasury-details.*') || request()->routeIs('division.change-bill-order-no.*') || request()->routeIs('division.delete-advice.*') ? 'open' : '' }}>
                    ...
                    <details class="nav-group" open>
                        ...
                        <div class="nav-submenu"><a href="{{ route('division.parties.index') }}">Party Registration</a><a class="{{ request()->routeIs('division.cash-accounts.*') ? 'active' : '' }}" href="{{ route('division.cash-accounts.index') }}">Cash Account</a><a class="{{ request()->routeIs('division.allotments-from-circle.*') ? 'active' : '' }}" href="{{ route('division.allotments-from-circle.index') }}">Allotment from Circle</a><a class="{{ request()->routeIs('division.allotments-to-range.*') ? 'active' : '' }}" href="{{ route('division.allotments-to-range.create') }}">Allotment to Range</a><a class="{{ request()->routeIs('division.allotment-adjustments.*') ? 'active' : '' }}" href="{{ route('division.allotment-adjustments.index') }}">Allotment Adjustment</a><a class="{{ request()->routeIs('division.lc-entries.*') ? 'active' : '' }}" href="{{ route('division.lc-entries.index') }}">LC Entry</a></div>
                    </details>
                @endif
