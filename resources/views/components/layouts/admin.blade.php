        ...
        <aside id="sidebar" class="sidebar border-r border-emerald-100 bg-white/95 shadow-sm">
            ...
            <nav class="sidebar-nav space-y-1 px-3 py-4">
                ...
                @if(auth()->user()->isDivision())
                    ...
                    <details class="nav-group" {{ request()->routeIs('division.process-bill.*') || request()->routeIs('division.gst-challan.*') || request()->routeIs('division.bill-advice-reports.*') || request()->routeIs('division.treasury-details.*') ? 'open' : '' }}>
